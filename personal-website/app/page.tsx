  ...
  return (
    <main className="page h-full flex flex-row justify-between text-white bg-gray-background">
      ...
      <div className='h-full w-1/2 flex flex-col item-center overflow-y-scroll scrollbar-hide'>
        ...
        <div className='w-full h-fit mb-28 p-16 font-karla text-2xl bg-gray-dark bg-opacity-20'>
        ...
        <div className='w-full h-fit mb-28 p-16 font-karla text-2xl bg-gray-dark bg-opacity-20'>
          ...
          <p>
            I’ve been drawing since I was 10, but I started to focus on my art around three years ago. Here you can find some of my best illustrations, projects and work at a glance.
          </p>
        </div>
        ...
        <div className='w-full h-fit p-16  font-karla text-2xl bg-gray-dark bg-opacity-20'>
